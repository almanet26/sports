...
const translations = {
  en: {
    ...
    insightsDesc: 'Receive feedback & performance summary',
  ...
  es: {
    ...
    insightsDesc: 'Recibe retroalimentación y resumen de rendimiento',
  ...
  fr: {
    ...
    insightsDesc: 'Recevez des retours et un résumé des performances',
  ...
  de: {
    ...
    insightsDesc: 'Erhalten Sie Feedback und eine Leistungszusammenfassung',
  ...
  hi: {
    ...
    insightsDesc: 'प्रतिक्रिया और प्रदर्शन सारांश प्राप्त करें',
