                ...
                <div key={item.label} className="flex items-start gap-4 rounded-[20px] border border-white/10 bg-slate-950/70 p-4">
                  <div
                    className={`mt-0.5 flex h-10 w-10 items-center justify-center rounded-2xl ${
                      item.completed ? "bg-gradient-to-br from-emerald-500 to-teal-500" : "bg-white/[0.05]"
                    }`}
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`rounded-full px-2 py-0.5 text-[11px] ${
                          item.completed ? "bg-emerald-400/10 text-emerald-200" : "bg-amber-400/10 text-amber-200"
                        }`}
                      >
                          ...
                          <label key={field.key} className="block">
                            ...
                            {"options" in field ? (
                              (() => {
                                ...
                                return (
                                  <select
                                    ...
                                    className={`w-full rounded-2xl border bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition focus:ring-2 ${
                                      formErrors[field.key as ProfileFieldName]
                              ...
                              <input
                                ...
                                className={`w-full rounded-2xl border bg-slate-950/80 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 focus:ring-2 ${
                                  formErrors[field.key as ProfileFieldName]
                                    ? "border-rose-400/60 focus:border-rose-400/60 focus:ring-rose-500/20"
                                    : "border-white/10 focus:border-blue-400/40 focus:ring-blue-500/20"
                                }`}
