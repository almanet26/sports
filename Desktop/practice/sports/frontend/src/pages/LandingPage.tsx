...
import {
  Clock, Wrench, Puzzle,
  Crosshair, Brain, Lightbulb, BarChart2, Film, Activity,
...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    getCoach: 'Improve.',
    description: 'PitchVision lets you create, edit and share clips from any online video (YouTube, Twitch, ...)',
    registerBtn: 'REGISTER NOW FOR FREE',
    watchDemo: 'WATCH DEMO',
    heroDescription: 'PitchVision analyzes your bowling, batting and fielding videos to provide detailed performance insights, technique improvements, and match highlights- helping cricketers at all levels improve faster.',
    ...
    successDesc: 'See how coaches like you are transforming their teams with PitchVision',
    ...
    createEdit: 'PitchVision lets you create, edit and share clips from any online video (YouTube, Twitch, ...)',
    ...
    signIn: 'SIGN IN',
    copyright: '© 2024 PitchVision • Powered Cricket Highlight Generator'
  },
  es: {
    ...
    getCoach: 'Mejora.',
    description: 'PitchVision te permite crear, editar y compartir clips de cualquier video en línea (YouTube, Twitch, ...)',
    registerBtn: 'REGÍSTRATE GRATIS AHORA',
    watchDemo: 'VER DEMOSTRACIÓN',
    heroDescription: 'PitchVision analiza tus videos de bowling, batting y fielding para proporcionar información detallada de rendimiento, mejoras de técnica y destacados de partidos, ayudando a jugadores de cricket de todos los niveles a mejorar más rápido.',
    ...
    successDesc: 'Mira cómo entrenadores como tú están transformando sus equipos con PitchVision',
    ...
    createEdit: 'PitchVision te permite crear, editar y compartir clips de cualquier video en línea (YouTube, Twitch, ...)',
    ...
    copyright: '© 2024 PitchVision • Generador de Destacados de Cricket'
  },
  fr: {
    ...
    description: 'PitchVision vous permet de créer, modifier et partager des clips à partir de n\'importe quelle vidéo en ligne (YouTube, Twitch, ...)',
    registerBtn: 'S\'INSCRIRE GRATUITEMENT MAINTENANT',
    watchDemo: 'REGARDER LA DÉMO',
    heroDescription: 'PitchVision analyse vos vidéos de bowling, batting et fielding pour fournir des informations détaillées sur les performances, des améliorations techniques et des faits saillants de match, aidant les joueurs de cricket de tous les niveaux à s\'améliorer plus rapidement.',
    ...
    successDesc: 'Découvrez comment des entraîneurs comme vous transforment leurs équipes avec PitchVision',
    ...
    createEdit: 'PitchVision vous permet de créer, modifier et partager des clips à partir de n\'importe quelle vidéo en ligne (YouTube, Twitch, ...)',
    ...
    signIn: 'SE CONNECTER',
    copyright: '© 2024 PitchVision • Générateur de Faits Saillants de Cricket'
  },
  de: {
    features: 'FUNKTIONEN',
    ...
    description: 'PitchVision ermöglicht es Ihnen, Clips aus jedem Online-Video (YouTube, Twitch, ...) zu erstellen, zu bearbeiten und zu teilen',
    registerBtn: 'JETZT KOSTENLOS REGISTRIEREN',
    watchDemo: 'DEMO ANSEHEN',
    heroDescription: 'PitchVision analysiert Ihre Bowling-, Batting- und Fielding-Videos, um detaillierte Leistungseinblicke, Technikverbesserungen und Match-Highlights bereitzustellen und Cricketspielern aller Niveaus zu helfen, schneller zu verbessern.',
    ...
    successDesc: 'Sehen Sie, wie Trainer wie Sie ihre Teams mit PitchVision transformieren',
    ...
    createEdit: 'PitchVision ermöglicht es Ihnen, Clips aus jedem Online-Video (YouTube, Twitch, ...) zu erstellen, zu bearbeiten und zu teilen',
    ...
    signIn: 'ANMELDEN',
    copyright: '© 2024 PitchVision • Cricket-Highlight-Generator'
  },
  hi: {
    features: 'विशेषताएं',
    ...
    getCoach: 'सुधार करें।',
    description: 'PitchVision आपको किसी भी ऑनलाइन वीडियो (YouTube, Twitch, ...) से क्लिप बनाने, संपादित करने और साझा करने देता है',
    registerBtn: 'अभी मुफ्त में पंजीकरण करें',
    watchDemo: 'डेमो देखें',
    heroDescription: 'PitchVision आपकी बॉलिंग, बैटिंग और फील्डिंग वीडियो का विश्लेषण करता है ताकि विस्तृत प्रदर्शन अंतर्दृष्टि, तकनीक सुधार और मैच हाइलाइट प्रदान किए जा सकें, जो सभी स्तरों के क्रिकेटरों को तेजी से सुधार करने में मदद करता है।',
    ...
    successDesc: 'देखें कि आपके जैसे कोच PitchVision के साथ अपनी टीमों को कैसे बदल रहे हैं',
    ...
    createEdit: 'PitchVision आपको किसी भी ऑनलाइन वीडियो (YouTube, Twitch, ...) से क्लिप बनाने, संपादित करने और साझा करने देता है',
    ...
    signIn: 'साइन इन करें',
    copyright: '© 2024 PitchVision • क्रिकेट हाइलाइट जनरेटर'
  }
};
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur border-b border-slate-700 relative">
            ...
            <motion.div whileHover={{ scale: 1.05 }}>
              <Link to="/" className="flex items-center gap-2">
                <div className="w-10 h-10 rounded-lg overflow-hidden hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300">
                  <img src={appLogo} alt="PitchVision Logo" className="w-full h-full object-cover" />
                </div>
                <span className="text-xl font-bold text-white">PitchVision</span>
              </Link>
            </motion.div>
        ...
        {/* Mobile drawer */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-slate-900/95 border-t border-slate-700 px-4 py-4 flex flex-col gap-4">
            {['Features', 'Testimonials', 'Pricing', 'FAQ'].map((item) => (
              <a
                ...
                className="text-gray-300 hover:text-white font-medium text-sm py-1"
              >
                {item}
              </a>
            ))}
            <select
              value={language}
              onChange={(e) => setLanguage(e.target.value)}
              className="text-gray-300 text-sm bg-slate-800 border border-slate-600 rounded px-2 py-1 focus:outline-none w-full"
            >
              <option value="en">English</option>
              <option value="es">Español</option>
              <option value="fr">Français</option>
      ...
      <section className="bg-slate-800/50 py-16 px-4 relative">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              {[
                { icon: Zap, label: 'Instant Performance Insights', desc: 'Get results right after upload' },
                { icon: Target, label: 'Personalized Coaching Feedback', desc: 'Tailored to your technique' },
                { icon: Users, label: 'Coach-to-Player Interaction', desc: 'Direct coaching insights' },
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial={{ scale: 0.8 }}
                  ...
                  viewport={{ once: true }}
                >
                  <div className="w-12 h-12 bg-[image:var(--primary-gradient)] rounded-full flex items-center justify-center mx-auto mb-3">
      ...
      <section className="py-20 px-4 bg-slate-900 relative">
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white text-center mb-6">
              Do these problems sound familiar to you?
            </h2>
            <p className="text-lg text-gray-300 text-center mb-16">
              You don't need the same tools used by professional teams. You need something effective, accessible, and that adapts to your pace. PitchVision is designed exactly for that: real coaches, with real budgets, who want real results.
            </p>
          </motion.div>
          ...
          <div className="space-y-8">
            {[
              ...
              },
              {
                ...
                desc: 'Professional video analysis software costs thousands. PitchVision provides enterprise-level analysis at a fraction of the cost.'
              },
              {
                icon: Puzzle,
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc: 'Real-time motion detection and frame-by-frame analysis to identify key moments and movement patterns'
              },
              {
                icon: Film,
              ...
              >
                ...
                >
                  {(() => { const Icon = feature.icon; return <Icon className="w-10 h-10 text-white" />; })()}
                </motion.div>
            ...
            {[
              ...
              >
                <motion.div
                  ...
                  className="w-14 h-14 bg-[image:var(--primary-gradient)] rounded-full flex items-center justify-center mb-4 mx-auto"
                >
                  {(() => { const Icon = item.icon; return <Icon className="w-7 h-7 text-white" />; })()}
                </motion.div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-slate-800 rounded-lg max-w-2xl w-full">
            <div className="flex justify-between items-center p-6 border-b border-slate-700">
              <h3 className="text-xl font-bold text-white">PitchVision Demo</h3>
              <button 
            ...
            <div className="p-6">
              <div className="relative w-full aspect-video bg-slate-900 rounded-lg overflow-hidden flex flex-col items-center justify-center gap-3 border border-slate-700">
                <Play className="w-12 h-12 text-purple-400" />
                <p className="text-white font-bold text-lg">Demo Coming Soon</p>
                <p className="text-gray-400 text-sm">We're putting the finishing touches on our demo video.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {[
              ...
              {
                quote: 'PitchVision cut my analysis time by 80%. Now I focus on coaching, not editing.',
                name: 'Rajesh Kumar',
                role: 'Cricket Coach',
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="inline-block mb-6 px-4 py-2 bg-red-500/20 border border-red-500/50 rounded-full">
              <p className="text-red-400 font-bold text-sm flex items-center gap-1 justify-center"><Zap className="w-4 h-4" /> {t.limitedOffer}</p>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
              {t.readyToStart}
            </h2>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 justify-center">
            <div className="flex flex-col items-center gap-1">
              <span className="inline-flex items-center gap-1 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">
                <Flame className="w-3 h-3" /> Only 23 left
              </span>
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
            ...
            {[
              ...
              <div key={i} className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
                ...
                <div className="grid grid-cols-3 gap-2 text-center text-xs">
                  <div>
                    <p className="text-purple-400 font-bold mb-1">PitchVision</p>
                    {typeof row.cv === 'boolean' ? <span className={row.cv ? 'text-green-400 text-base' : 'text-gray-500 text-base'}>{row.cv ? '✓' : '✗'}</span> : <span className="text-purple-400 font-bold">{row.cv}</span>}
                  </div>
                  <div>
                    <p className="text-gray-400 mb-1">Comp. A</p>
                    {typeof row.c1 === 'boolean' ? <span className={row.c1 ? 'text-green-400 text-base' : 'text-gray-500 text-base'}>{row.c1 ? '✓' : '✗'}</span> : <span className="text-gray-300">{row.c1}</span>}
                  </div>
                  <div>
                    <p className="text-gray-400 mb-1">Comp. B</p>
                    {typeof row.c2 === 'boolean' ? <span className={row.c2 ? 'text-green-400 text-base' : 'text-gray-500 text-base'}>{row.c2 ? '✓' : '✗'}</span> : <span className="text-gray-300">{row.c2}</span>}
                  </div>
                </div>
              </div>
            ))}
              ...
              <thead>
                <tr className="border-b border-slate-600">
                  ...
                  <th className="px-6 py-4 text-center">
                    <div className="text-white font-bold">PitchVision</div>
      ...
      <section className="py-16 px-4 bg-slate-800/50 relative">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { icon: Lock, label: 'SSL Encrypted', desc: 'Your data is secure' },
              { icon: CheckCircle, label: 'GDPR Compliant', desc: 'Privacy protected' },
              { icon: Star, label: '4.9/5 Rating', desc: '500+ reviews' },
              { icon: Trophy, label: 'Award Winning', desc: 'Industry recognized' }
            ].map((item, i) => (
              <motion.div
                key={i}
                ...
                viewport={{ once: true }}
              >
                <div className="w-12 h-12 bg-[image:var(--primary-gradient)] rounded-full flex items-center justify-center mb-2 mx-auto">
                  {(() => { const Icon = item.icon; return <Icon className="w-6 h-6 text-white" />; })()}
                </div>
                <p className="text-white font-bold text-sm">{item.label}</p>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'No! PitchVision is designed for coaches, not tech experts. Our interface is intuitive and easy to learn.'
              },
              {
              ...
              {
                q: 'What sports does PitchVision support?',
      ...
      <footer className="bg-slate-950 text-white py-8 px-4 border-t border-slate-700">
        <div className="max-w-6xl mx-auto">
          {/* Newsletter */}
          <div className="py-10 text-center border-b border-slate-700 mb-12">
            <h2 className="text-2xl font-black text-white mb-2">Stay in the Loop</h2>
            <p className="text-gray-400 text-sm mb-6">Get exclusive tips, product updates, and special offers delivered to your inbox</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#features" onClick={(e) => { e.preventDefault(); document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-400 hover:text-white transition cursor-pointer">Features</a></li>
                <li><Link to="/register" className="text-gray-400 hover:text-white transition">Pricing</Link></li>
                <li><a href="#" onClick={(e) => { e.preventDefault(); document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-400 hover:text-white transition cursor-pointer">How It Works</a></li>
                <li><a href="#testimonials" onClick={(e) => { e.preventDefault(); document.getElementById('testimonials')?.scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-400 hover:text-white transition cursor-pointer">Testimonials</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><span className="text-gray-600 cursor-not-allowed text-sm">Terms (coming soon)</span></li>
                <li><span className="text-gray-600 cursor-not-allowed text-sm">Privacy (coming soon)</span></li>
                <li><span className="text-gray-600 cursor-not-allowed text-sm">Contact (coming soon)</span></li>
              </ul>
            </div>
          ...
          <div className="border-t border-slate-700 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-gray-400 text-sm">
                Copyright © PitchVision {new Date().getFullYear()}
              </div>
            </div>
          </div>
        </div>
      ...
      <motion.button
        ...
        onClick={scrollToTop}
        className="fixed bottom-24 right-8 z-40 w-12 h-12 bg-[image:var(--primary-gradient)] rounded-full shadow-lg hover:shadow-xl flex items-center justify-center text-white transition-all duration-300 hover:scale-110"
        title="Scroll to top"
      >
      ...
      >
        {showChat && (
          <motion.div
            ...
            className="absolute bottom-20 right-0 w-[calc(100vw-2rem)] sm:w-96 bg-slate-800 border border-slate-600 rounded-lg shadow-2xl flex flex-col h-96 mb-4"
          >
            {/* Chat Header */}
